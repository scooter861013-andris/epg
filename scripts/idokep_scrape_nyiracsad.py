...
# KONFIG
# -------------------------------------------------
LOCATION = os.getenv("IDOKEP_LOCATION", "Nyiracsad")
...
old_data = None
if os.path.exists("idokep_nyiracsad.json"):
    with open("idokep_nyiracsad.json", "r", encoding="utf-8") as f:
...
with open("idokep_nyiracsad.json", "w", encoding="utf-8") as f:
